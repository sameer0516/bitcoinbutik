'use client';
// app/collections/pendants/pendant-mens/[mansSlug]/ManDetailClient.jsx
// ✅ All interactive logic yahan — 'use client' yahan hai
...
// ✅ FIX: Safe localStorage wrapper — SSR crash nahi karega
...
export default function ManDetailClient({ mansSlug }) {
    ...
    // ✅ FIX: useCallback + safeLocalStorage
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            ...
            try {
                const sessionKey = `product_${mansSlug}`;
                let passedData = null;
                ...
                try {
                    const slugRes = await fetch(`${API_URL}/api/products/slug/${mansSlug}`);
                    if (slugRes.ok) {
                ...
                // ✅ Fallback: fetch all Man products and find by slug
                ...
                const foundProduct = allProducts.find((p) => {
                    ...
                    return titleSlug === mansSlug;
                });

                if (!foundProduct) throw new Error(`Product not found for slug: "${mansSlug}"`);
        ...
        fetchProduct();
    }, [mansSlug, fetchLatestStock]);

    // ✅ FIX: Poll every 30s instead of 3s — server load kam hoga
    useEffect(() => {
    ...
    // ✅ FIX: fetchLatestStock dependency array mein add kiya
    useEffect(() => {
    ...
    useEffect(() => { setCurrentMediaIndex(0); }, [mansSlug]);
                    ...
                    <div className="tab-pane">
                        ...
                        <ul>
                            <li className="detail-item">
                                <strong>Type:</strong> Pendant with Chain <span>{product.type}</span>
                            </li>
                            <li className="detail-item">
